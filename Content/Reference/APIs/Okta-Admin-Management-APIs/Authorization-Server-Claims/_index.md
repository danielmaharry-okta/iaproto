+++
title = 'Authorization Server Claims'
date = 16:17:45
weight = 353
alwaysopen = false
+++

## Authorization Server Claims API
...
**Links to original docs**: https://developer.okta.com/docs/api/openapi/okta-management/management/tag/AuthorizationServerClaims/
