+++
title = 'Associated Authorization Servers'
date = 16:17:45
weight = 352
alwaysopen = false
+++

## Associated Authorization Servers API
...
**Links to original docs**: https://developer.okta.com/docs/api/openapi/okta-management/management/tag/AuthorizationServerAssoc/
