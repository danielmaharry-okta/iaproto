+++
title = 'Use ngrok to subscribe to an event hook'
date = 16:17:44
weight = 198
alwaysopen = false
+++

## Use ngrok to subscribe to an event hook
...
**Links to original docs**: - Event hooks with ngrok: https://developer.okta.com/docs/guides/event-hook-ngrok/nodejs/main/
