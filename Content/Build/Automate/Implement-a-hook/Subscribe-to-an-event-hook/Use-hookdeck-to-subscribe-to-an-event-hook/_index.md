+++
title = 'Use hookdeck to subscribe to an event hook'
date = 16:17:44
weight = 199
alwaysopen = false
+++

## Use hookdeck to subscribe to an event hook
...
**Links to original docs**: - Event hooks with Hookdeck: https://developer.okta.com/docs/guides/event-hook-hookdeck/nodejs/main/
